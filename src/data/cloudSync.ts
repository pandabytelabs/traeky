...
/**
 * Domain-level representation of what should be stored in an online sync service.
 *
 * NOTE:
 ...
 * remote sync service. It ensures that the backend only ever sees encrypted
