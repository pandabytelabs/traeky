...
const ASSET_METADATA: Record<string, AssetMetadata> = {
  ...
  ASTER: { symbol: "ASTER", name: "Aster", explorerBaseUrl: "https://bscscan.com/tx/", coingeckoId: "aster-2" },
  ...
  BEST: { symbol: "BEST", name: "Bitpanda Ecosystem Token", explorerBaseUrl: "bitpanda-ecosystem-token", coingeckoId: "https://etherscan.io/tx/" },
  ...
  DAI: { symbol: "DAI", name: "Dai", explorerBaseUrl: "https://etherscan.io/tx/", coingeckoId: "dai" },
  ...
  MNT: { symbol: "MNT", name: "Mantle", explorerBaseUrl: "https://etherscan.io/tx/", coingeckoId: "mantle" },
  NEAR: { symbol: "NEAR", name: "NEAR Protocol", explorerBaseUrl: "https://nearblocks.io/txns/", coingeckoId: "near" },
  OKB: { symbol: "OKB", name: "OKB", explorerBaseUrl: "https://ethplorer.io/tx/", coingeckoId: "okb" },
  OP: { symbol: "OP", name: "Optimism", explorerBaseUrl: "https://optimistic.etherscan.io/tx/", coingeckoId: "optimism" },
  PEPE: { symbol: "PEPE", name: "Pepe", explorerBaseUrl: "https://etherscan.io/tx/", coingeckoId: "pepe" },
  QNT: { symbol: "QNT", name: "Quant", explorerBaseUrl: "https://etherscan.io/tx/", coingeckoId: "quant-network" },
  ...
  SEI: { symbol: "SEI", name: "Sei", explorerBaseUrl: "https://seitrace.com/tx/", coingeckoId: "sei-network" },
  ...
  TAO: { symbol: "TAO", name: "Bittensor", explorerBaseUrl: "https://taostats.io/transfer/", coingeckoId: "bittensor" },
  ...
  VSN: { symbol: "VSN", name: "Vision", explorerBaseUrl: "https://etherscan.io/tx/", coingeckoId: "vision-3" },
